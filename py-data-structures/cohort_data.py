...
def all_names_by_house(filename):
    ...
    for line in open(filename):
        info = line.split('|')
        if info[2] == "Dumbledore's Army":
            dumbledores_army.append(f'{info[0]} {info[1]}')
        elif info[2] == 'Hufflepuff':
            hufflepuff.append(f'{info[0]} {info[1]}')
        elif info[2] == 'Ravenclaw':
            ravenclaw.append(f'{info[0]} {info[1]}')
        elif info[2] == 'Gryffindor':
            gryffindor.append(f'{info[0]} {info[1]}')
        elif info[2] == 'Slytherin':
            slytherin.append(f'{info[0]} {info[1]}')
        elif info[4] == 'G':
            ghosts.append(f'{info[0]} {info[1]}')
        elif info[4] == 'I':
            instructors.append(f'{info[0]} {info[1]}')
    return []
